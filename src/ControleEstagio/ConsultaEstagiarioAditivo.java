...
public class ConsultaEstagiarioAditivo extends javax.swing.JFrame {
    
    Connection conn;
    TermoAditivo fTermoAditivo = null;

    public ConsultaEstagiarioAditivo() {
        initComponents();
    }
    
     public ConsultaEstagiarioAditivo(Connection conn, TermoAditivo fTermoAditivo, String Estagiario) {
        initComponents();
  ...
  if(TConsultaEst.getSelectedRowCount() == 1){
            ...
            String Estagiario = fTermoAditivo.TFNomeEstagAditivo.getText();
            
            try{
                Statement stmt = conn.createStatement();
                ResultSet rs = stmt.executeQuery("SELECT * FROM aluno a WHERE nome like '%"+Estagiario+"%' ORDER BY nome");
        ...
        fTermoAditivo.TFNomeEstagAditivo.setText(NomeEst);
        fTermoAditivo.TFCursoEstagAditivo.setText(CursoEst);
        fTermoAditivo.TFEmailEstagAditivo.setText(EmailEst);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConsultaEstagiarioAditivo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                new ConsultaEstagiarioAditivo().setVisible(true);
            }
        });
    }
