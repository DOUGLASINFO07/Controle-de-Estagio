...
public class ConsultaConcedente extends javax.swing.JFrame {
    
    Connection conn = null;
    TermoCompromisso fTermoObrigatorio = null;

    public ConsultaConcedente() {
        initComponents();
    }
    
     public ConsultaConcedente(Connection conn, TermoCompromisso fTermoObrigatorio, String Concedente) {
        initComponents();
        ...
        if(TConsultaConc.getSelectedRowCount() == 1){
            ...
            try{
                ...
                while(rs.next()){
                    ...
                    String CNPJConc = rs.getString("cnpj");
                    String EndConc = rs.getString("endereco");
                    String NumEndConc = rs.getString("Numero");
                    String CEPConc = rs.getString("cep");
                    String BairroConc = rs.getString("bairro");
                    String CidadeConc = rs.getString("cidade");
                    String EstadoConc = rs.getString("uf");
                    String TelConc = rs.getString("telefone");
                    String RepConc = rs.getString("representante");
                    String CPFRepConc = rs.getString("CPF");
                    String CargoConc = rs.getString("cargo");

                    
                    fTermoObrigatorio.concedente = codigo;
                    fTermoObrigatorio.TFNomeConc.setText(NomeConc);
                    fTermoObrigatorio.TFCNPJConc.setText(CNPJConc);
                    fTermoObrigatorio.TFEndConc.setText(EndConc);
                    fTermoObrigatorio.TFNumEndConc.setText(NumEndConc);
                    fTermoObrigatorio.TFCEPConc.setText(CEPConc);  
                    fTermoObrigatorio.TFBairroConc.setText( BairroConc);
                    fTermoObrigatorio.TFCidadeConc.setText(CidadeConc);
                    fTermoObrigatorio.TFEstadoConc.setText(EstadoConc);                  
                    fTermoObrigatorio.TFTelConc.setText(TelConc);
                    fTermoObrigatorio.TFRepConc.setText(RepConc);
                    fTermoObrigatorio.TFCPFRepConc.setText(CPFRepConc);
                    fTermoObrigatorio.TFCargoRepConc.setText(CargoConc);
                    
                    fTermoObrigatorio.TFRespConc.setEditable(true);
                    fTermoObrigatorio.TFCPFRespConc.setEditable(true);
                    fTermoObrigatorio.TFCargoRespConc.setEditable(true);
                }
                rs.close();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConsultaConcedente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ConsultaConcedente().setVisible(true);
            }
        });
    }
