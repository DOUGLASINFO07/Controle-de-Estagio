...
public class ConsultaIntervenienteAditivo extends javax.swing.JFrame {
    
    Connection conn;
    TermoAditivo fTermoAditivo;

    public ConsultaIntervenienteAditivo() {
        initComponents();
    }
    
    public ConsultaIntervenienteAditivo(Connection conn, TermoAditivo fTermoAditivo, String Interveniente) {
        initComponents();
    ...
    private void BSelecionarAlunoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BSelecionarAlunoActionPerformed
        ...
        fTermoAditivo.TFNomeIntervAditivo.setText(RazaoSocial);
        fTermoAditivo.TFRepIntervAditivo.setText(NomeRepInterv);
        fTermoAditivo.TFCargoRepIntervAditivo.setText(CargoRepInterv);
        
        fTermoAditivo.TFRepIntervAditivo.setEditable(true);
        fTermoAditivo.TFCargoRepIntervAditivo.setEditable(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConsultaIntervenienteAditivo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                new ConsultaIntervenienteAditivo().setVisible(true);
            }
        });
    }
    // Variables declaration - do not modify//GEN-BEGIN:variables
    public javax.swing.JButton BFecharAluno;
    public javax.swing.JButton BSelecionarAluno;
    public javax.swing.JTable TConsultaInterv;
