...
public class RelatorioAluno extends javax.swing.JFrame {
    ...
    public RelatorioAluno(Connection conn) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel26.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagem/Bot_Verm_RELATORIO_aLUNO.png"))); // NOI18N
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(jPanel1Layout.createSequentialGroup()
                                        ...
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                        .addComponent(TFFiltroDataFinal, javax.swing.GroupLayout.PREFERRED_SIZE, 172, javax.swing.GroupLayout.PREFERRED_SIZE)))
                                .addGap(55, 55, 55)
    ...
    private void BBuscarDadoasRelatorioAlunoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BBuscarDadoasRelatorioAlunoActionPerformed
        ...
        TRelatorioAluno.getModel();

        while(TRelatorioAluno.getRowCount() > 0){
            m.removeRow(0);
        }

        String PorAluno = TFFiltroPorAluno.getText();
        String PeriodoInicio = TFFiltroDataInicial.getText();
        String PeriodoFim = TFFiltroDataInicial.getText();
        String situacao = (RBEstagioConcluido.isSelected()?"Concluído":"Não Concluído");

        try{
            Statement stmt = conn.createStatement();
            ResultSet rs = stmt.executeQuery(
                "SELECT * FROM Controle WHERE /* NomeAluno LIKE '"+PorAluno+"%' "
                        + "OR (BETWEEN "+PeriodoInicio+" AND "+PeriodoFim+")"
                        + "AND SITUACAO LIKE '"+situacao+"%' ORDER BY '"+PorAluno+"'");
            ...
            while(rs.next()){
                ...
                String HoraEstagio = rs.getString("HoraEstagio");
                String HoraPendente = rs.getString("HoraPendente");
                String Situacao = rs.getString("Situacao");

                m.addRow(new Object[] {NomeAluno, Curso, Concedente, NumeroTCE, DataInicio, DataTermino, HoraEstagio, HoraPendente, Situacao});

            }

        }catch(Exception e){
            System.out.println(
                "Error ao consultar Controle: "+e.getMessage());
        }
